...
const Slider = () => {
  ...
  return (
    <div>
      ...
      <div className="w-[500px] mx-auto overflow-hidden rounded-[35px]">
        <div className={`flex transform transition-transform duration-300 ease-in-out text-2xl tracking-normal ${currentSlide === 0 ? "translate-x-0" : currentSlide === 1 ? "-translate-x-[500px]" : currentSlide === 2 ? "-translate-x-[1000px]" : "-translate-x-[1500px]"} text-white font-body`}>
          <div className="min-w-[500px] h-[240px] bg-primary p-8">
      ...
      <div className="flex justify-center space-x-4 py-4">
        <span className={`h-[5px] w-24 transition-colors ease-in duration-200 ${currentSlide === 0 ? "bg-primary" : "bg-gray-300"}`} />
        <span className={`h-[5px] w-24 transition-colors ease-in duration-200 ${currentSlide === 1 ? "bg-primary" : "bg-gray-300"}`} />
        <span className={`h-[5px] w-24 transition-colors ease-in duration-200 ${currentSlide === 2 ? "bg-primary" : "bg-gray-300"}`} />
        <span className={`h-[5px] w-24 transition-colors ease-in duration-200 ${currentSlide === 3 ? "bg-primary" : "bg-gray-300"}`} />
      </div>
    </div>
  )
}
