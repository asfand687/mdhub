      ...
      <div className="max-w-[1100px] mx-auto space-y-20">
        <article className="flex items-center gap-x-12">
          ...
          <div className="flex-1">
            ...
            <button className={`rounded-full text-lg group hover:ring-1 hover:ring-primary px-10 py-2 border flex justify-center items-center space-x-2  border-primary bg-transparent shadow-cardService`}>
              Sign Up Your Child Today
            </button>
          </div>
        </article>

        <article className="grid grid-cols-3 gap-x-12 gap-y-8">
          {
        ...
        <article className="relative w-full py-8 px-12 border-[0.25px] rounded-3xl shadow-cardService space-y-7 text-lg">
          <img src={ForBabies07} alt="Benefits for Babies" className="absolute right-16 top-20" />
          <h2 className="text-4xl">What We Can Help With</h2>
          <div className="flex gap-x-24 font-light font-body">
